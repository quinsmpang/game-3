...
public class MailSender {
	...
	public static void sendMail(String address, String title, String content) {
		try {
			...
			mailInfo.setMailServerHost("mail.pook.com");
			mailInfo.setMailServerPort("25");
			mailInfo.setValidate(true);
			mailInfo.setUserName(Conf.mailUsername);
			mailInfo.setPassword(Conf.mailPassword);
			mailInfo.setFromAddress(Conf.mailSender);
