...
public class IPSeeker {
	...
	private static String IP_FILE;// = IPSeeker.class.getResource("QQWry.dat").toString().substring(5);
//	private static String IP_FILE = "";
	...
	private static final HashMap<String, String> province=new HashMap<String, String>();
	 
	static{
		province.put("石家庄", "河北省");
		province.put("太原", "山西省");
		province.put("沈阳", "辽宁省");
		province.put("长春", "吉林省");
		province.put("哈尔滨", "黑龙江省");
		province.put("南京", "江苏省");
		province.put("杭州", "浙江省");
		province.put("合肥", "安徽省");
		province.put("福州", "福建省");
		...
		province.put("澳门", "澳门");
		province.put("香港", "香港");
		province.put("乌鲁木齐", "新疆");
		province.put("呼和浩特", "内蒙古");
		province.put("北京市", "北京");
		province.put("上海市", "上海");
		province.put("天津市", "天津");
		province.put("重庆市", "重庆");
	...
	private IPSeeker() {
		...
		try {
			...
			IP_FILE = ServerConfig.getWebInfPath()+"res/file/QQWry.dat";
	...
	public String getProvince(String ip) {
		...
		String str_province="";
		if(country==null)return "unKnow";
		Collection<String> vlues= province.values();
		for (String str : vlues) 
			if(country.startsWith(str))
				return str_province=str;
		Set<String> keys=province.keySet();
		for (String str : keys) 
			if(country.startsWith(str))
				return str_province=province.get(str);
