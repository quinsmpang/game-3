...
function checkForm()
{
	...
	theForm.action="activatecode_batch_upload.jsp";
	theForm.submit();
              ...
              <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr> 
                  ...
                  <td colspan="2" align="center" valign="top"><table width="95%" border="0" cellspacing="1" cellpadding="2">
                      <tr> 
                        <td><fieldset><legend>批量生成激活码</legend>
                            
                            <table width="100%" border="0" cellspacing="1" cellpadding="2">    
                            <tr>
                              <td width="10%" align="right" nowrap class="nrbgc1"><strong>激活码位数</strong></td>
                              <td width="93%" class="nrbgc1"><input name="len" type="text" id="len" value=""><font color="#FF0000">*</font></td></tr>
<tr>
  <td width="10%" align="right" nowrap class="nrbgc1"><strong>激活码格式</strong></td>
...
<tr>
<td width="10%" align="right" nowrap class="nrbgc1"><strong>预约开启日期</strong></td>
<td width="93%" class="nrbgc1"><font color="#FF0000"><input name="starttime" type="text" id="starttime" value="" onFocus="setday(this)"></font></td>
</tr>
<tr>
<td width="10%" align="right" nowrap class="nrbgc1"><strong>标签</strong></td>
<td width="93%" class="nrbgc1"><font color="#FF0000"><input name="mark" type="text" id="mark" value=""></font></td>
</tr>
                            </table>
