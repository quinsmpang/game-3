...
JSONObject xml = ApkVerBAC.getInstance().getJsonObj("id="+id);
if(xml!=null)
{
...
function checkForm()
{
	...
	theForm.action="apk_ver_upload.jsp";
	theForm.submit();
...
<tr><td width="10%" align="right" nowrap class="nrbgc1"><strong>必须升级</strong></td><td width="93%" class="nrbgc1"><label>
  <select name="mustupdate" id="mustupdate">
    <option value="1">是</option>
    <option value="0">否</option>
  </select>
  </label></td></tr>
<tr><td width="10%" align="right" nowrap class="nrbgc1"><strong>文件大小</strong></td><td width="93%" class="nrbgc1"><input name="filesize" type="text" value="">
