...
<%
boolean isSubmit = Tools.str2boolean(request.getParameter("submit"));
if(isSubmit){
	ReturnValue rv = EnsitiveWordBAC.getInstance().dataImport(pageContext);
%>
...
function checkForm()
{
	...
	theForm.action="ensitiveword_import.jsp?submit=1";
	theForm.submit();
              ...
              <tr> 
                <td width="1" valign="bottom" ><table width="100%"  border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    ...
                    <td nowrap background="../images/tab_midbak.gif">敏感词管理</td>
              ...
              <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr> 
                  ...
                  <td colspan="2" align="center" valign="top"><table width="95%" border="0" cellspacing="1" cellpadding="2">
                      <tr> 
                        <td><fieldset><legend>导入</legend>
                            
                            <table width="100%" border="0" cellspacing="1" cellpadding="2">    
                            <tr><td width="10%" align="right" nowrap class="nrbgc1"><strong>选择文件</strong></td><td width="93%" class="nrbgc1">
                              <input type="file" name="importfile">
<%
File demofile = new File(Conf.logRoot+"ensitiveword/demo.txt");
if(!demofile.exists()){
...
fileutil.writeNewToTxt(Conf.logRoot+"ensitiveword/demo.txt", sb.toString());
}
%>
<a href="../../download.do?path=<%=Conf.logRoot+"ensitiveword/demo.txt"%>">下载DEMO</a><font color="#ff0000">（请保证上传文件的内容编码为UTF8）</font>
                              </td></tr>
