...
JSONObject xml = serverExcMailBAC.getJsonObj("id="+id);
if(xml!=null)
{
name=xml.optString("name");
mailaddr=xml.optString("mailaddr");
...
function checkForm()
{
	...
	theForm.action="serverexcmail_upload.jsp";
	theForm.submit();
                  ...
                  <td colspan="2" align="center" valign="top"><table width="95%" border="0" cellspacing="1" cellpadding="2">
                      <tr> 
                        <td><fieldset><legend>编辑</legend>
                            ...
                            <tr><td width="10%" align="right" nowrap class="nrbgc1"><strong>发送人</strong></td><td width="93%" class="nrbgc1"><input name="name" type="text" value=""></td></tr>
<tr><td width="10%" align="right" nowrap class="nrbgc1"><strong>邮箱地址</strong></td><td width="93%" class="nrbgc1"><input name="mailaddr" type="text" value=""></td></tr>
