...
//日历处始化函数
	//把<div>日历容器，<form>_<input>输出文本框绑定到全局日历
 	var x = formElt.indexOf('.');
  	...
  	this.outbox=document.forms[formName].elements[formEltName];
...
function makeHeadGrid()
{
 ...
 //生成日历head的<table>对象，并设置日历head的背景颜色
    ...
    //生成日历隐藏按钮
    daysGrid=daysGrid + ' <td height="16" width="9"><img onclick =\'' + 'G_Calendar.hide()\' src="../images/x.gif" style="cursor:hand" alt="关闭" align="absmiddle" class="hand" alt="关闭">'
