...
function DynLayerInit(nestref) {
	...
	if (is.ns)
	{
		...
		for (var i=0; i<ref.getElementsByTagName("DIV").length; i++) {
			var divname = ref.getElementsByTagName("DIV")[i].id;
			alert(divname)
			...
			if (ref.getElementsByTagName("DIV")[i].getElementsByTagName("DIV").length > 0) {
				DynLayer.refArray[DynLayer.refArray.length] = (nestref=='')? ref.getElementsByTagName("DIV")[i].id : nestref+'.document.'+ref.getElementsByTagName("DIV")[i].id;
			}
		}
